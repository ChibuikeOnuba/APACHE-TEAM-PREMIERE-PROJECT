...
def prediction(race_B, Most Improved Player,
       Most Valuable Player, Finals MVP, All-Rookie Second Team,
       All-NBA First Team, All-NBA Second Team, All-Rookie First Team):

       # Making predictions
       prediction = classifier.predict(
       [[race_B, Most Improved Player,
              Most Valuable Player, Finals MVP, All-Rookie Second Team,
              All-NBA First Team, All-NBA Second Team, All-Rookie First Team]])
        if prediction == 0:
            pred = 'Not Awarded'
...
def main():
    ...
    if st.button("Predict"):
        result = prediction(race_B, Most Improved Player,
               Most Valuable Player, Finals MVP, All-Rookie Second Team,
               All-NBA First Team, All-NBA Second Team, All-Rookie First Team)
